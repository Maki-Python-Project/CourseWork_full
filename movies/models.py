...
class Movie(models.Model):
    ...
    directors = models.ManyToManyField(Actor, verbose_name = "режисери", related_name = "film_director")
    ...
    budget = models.PositiveBigIntegerField("Бюджет", default = 0, help_text = "вказувати суму в доларах")
    ...
    views = models.IntegerField('Перегляди', default=0, null=True, blank=True)
...
class Rating(models.Model):
    ...
    star = models.ForeignKey(RatingStar, on_delete = models.CASCADE, verbose_name = "зірка", related_name = "ratings")
...
class Reviews(models.Model):
    ...
    parent = models.ForeignKey('self', verbose_name = "Родич", on_delete = models.SET_NULL, blank = True, null = True)
    movie = models.ForeignKey(Movie, verbose_name = "фільм", on_delete = models.CASCADE)
